...
module.exports = require('./MapStore2/build/buildConfig')({
    bundles: {
        'ms3-training': path.join(__dirname, "js", "app"),
        'ms3-training-embedded': path.join(__dirname, "js", "embedded"),
        'ms3-training-api': path.join(__dirname, "MapStore2", "web", "client", "product", "api"),
